...
<section id="app">
    ...
    <div class="float-left col-md-3 center">
        ...
        <div v-for="product in products" class="product"><span class="name">{{product.name}} {{calcPrice(product.price)}}$</span><button class="btn btn-warning" @click="addToCart"><i class="fas fa-shopping-cart"></i></button></div>
    </div>
